...
def dispms(filename1=None,filename2=None,dims=None,DIMS=None,rgb=None,RGB=None,
           enhance=None,ENHANCE=None,sfn=None,cls=None,CLS=None,alpha=None,labels=None):
    gdal.AllRegister()
    if filename1 == None:
    ...
    try:
        if cls is None:
            ...
            classimg = inDataset1.GetRasterBand(rgb[1]).ReadAsArray(x0,y0,cols,rows).ravel()
